...
lis_user=[]
#Mention the name or hastag in above list in order to get the tweets of particular person or hashtag
...
for i in lis_user:
        ...
        while t:
            query_params = {'query': 'from:{} lang:de'.format(i),
			    #If query is for hashtag then instead of from:, mention hashtags name 
